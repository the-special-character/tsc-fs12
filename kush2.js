...
//count the highest selling product list with the product data 

// const calculateTotalQuantitiesForAllProducts = (carts) =>

  
//   carts.reduce((productQuantities, cart) => {
...
// const sortQuantitiesAscending = (quantities) => 
//   Object.entries(quantities).sort((a, b) => b[1] - a[1]);

// const mapProductsToQuantities = (sortedQuantities, products) => 
//   sortedQuantities.map(([productId, quantity]) => ({
//    ...products.find((product) => product.id === parseInt(productId)),
//     quantity,
//   }));

// const mappedProducts = mapProductsToQuantities(
//   sortQuantitiesAscending(
//     calculateTotalQuantitiesForAllProducts(carts)
//   ),
//   products
// );
...
//         p[product.productId] = (p[product.productId] || 0) + product.quantity;
//       });
//       console.log(p);
//       return p;
//     }, {}))
//     .sort((a, b) => b[1] - a[1]).map(([p1, sellQuntity]) => ({...products.find((product) => product.id === parseInt(p1)),sellQuntity,}));
//   console.log(count);
...
//     if (product) {
//       return p1 + product.quantity;
//     }
//     return p1;
//   }, 0);

//   if (index === -1) {
//     return [...p, {...c, totalPurchase }];
//   }
//   return [...p.slice(0,index), {...c, totalPurchase},...p.slice(index + 1)]
// }, []);
